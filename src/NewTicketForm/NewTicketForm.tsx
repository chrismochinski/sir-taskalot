...
export function NewTicketForm() {
  ...
  return (
    <Box className={cx(classes.dragonTicketPageWrapper)} my="0" py="0">
      <Box className={classes.blobWrapper} m="0" p="0">
        <svg
      ...
      <Box className={cx(classes.dragonTicketSuccessWrapper)} pt="0" my="0">
        <Flex
      ...
      <Box className={classes.dragRegion} id="bottom" />
    </Box>
  );
}
